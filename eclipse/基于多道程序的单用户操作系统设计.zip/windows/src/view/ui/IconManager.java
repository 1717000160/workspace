...
public class IconManager {
	...
	public static enum Type {
		FOLDER, HELP, TXT, START, CMD , CPU, EXE
	}

	private Icon[] icons;
	private final String[] ROUTES = { "images/help.png", "images/computer.png", "images/cpu.png" };
	private final Type[] TYPES = { Type.HELP, Type.FOLDER, Type.CPU };
	private final double ICON_WIDTH = 85;
	private final double ICON_HEIGHT = 85;
	private boolean isBeClick = false;
	private final String[] FILENAMES = { "帮助", "此电脑", "CPU" };
	private Window[] windows = { new Window(Main.getPrimaryStage(), Type.HELP, "帮助"),
			new Window(Main.getPrimaryStage(), Type.FOLDER, "此电脑"),
			new Window(Main.getPrimaryStage(), Type.CPU, "CPU") ,
