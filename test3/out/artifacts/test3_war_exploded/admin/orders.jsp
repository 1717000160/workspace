                    ...
                    <ul class="topbar-right">
                        <li class="dropdown dropdown-profile">
                            <a href="javascript:void(0)" data-toggle="dropdown">
                                <span>mrh <span class="caret"></span></span>
                            </a>
                        ...
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                <div class="toolbar-btn-action">
                                    <a class="btn btn-primary m-r-5" href="newUser.jsp"><i class="mdi mdi-plus"></i> 结账</a>
                                </div>
                            </div>
                            <div class="card-toolbar clearfix">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-btn">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a tabindex="-1" href="javascript:void(0)" data-field="title">桌号</a>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a class="btn btn-xs btn-default" href="#!" title="结账"
